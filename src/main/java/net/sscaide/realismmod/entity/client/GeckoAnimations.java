...
public class GeckoAnimations {
    ...
    public static final AnimationDefinition ANIME_GECKO_SLEEP = AnimationDefinition.Builder.withLength(0.0F).looping()
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.POSITION,
    ...
    public static final AnimationDefinition ANIM_GECKO_SWIM = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("Body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(0.625F, KeyframeAnimations.degreeVec(-13.0F, -42.0F, 12.5F), AnimationChannel.Interpolations.LINEAR),
